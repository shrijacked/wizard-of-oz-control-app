...
- Adaptive intervention guidance uses only the Maxim H Band HRV stream.
...
| T9 | Retire gaze collection from the experiment path and keep adaptive scoring HRV-only | T4, T6, T7 | Architecture: Sensor integration plan |
...
- Keep the live experiment path limited to the watch and camera
...
- Sensor health summaries warn when watch data goes stale
